...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (token && type) {
      ...
      router.replace(
        `/auth-callback?confirmation_token=${token}&type=${type}${email ? `&email=${encodeURIComponent(email)}` : ""}`,
      );
    }
  }, [router, searchParams]);
  ...
  const LogoSymbol = (
    ...
    >
      ...
      <path
        d="M11 18a7 7 0 0 1 7-7c2.5 0 4.7 1.36 5.89 3.39"
        stroke="#fff"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
      <path
        d="M25 18a7 7 0 0 1-7 7c-2.5 0-4.7-1.36-5.89-3.39"
        stroke="#fff"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
  ...
  const features = [
    ...
    },
    {
      ...
      icon: "📈",
      image:
        "https://images.pexels.com/photos/3184418/pexels-photo-3184418.jpeg?auto=compress&w=600&q=80",
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center px-0 py-0 font-sans">
        ...
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
          ...
          <ul className="hidden md:flex gap-8 items-center text-blue-700 font-medium">
            ...
            <li>
              <a
                href="/signup"
                className="ml-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-lg font-semibold hover:bg-blue-200 transition"
              >
                Get Started
              </a>
            </li>
      ...
      <section className="w-full bg-gradient-to-br from-blue-700 via-blue-500 to-blue-400 text-white py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-12">
          <div className="flex-1 max-w-xl z-10 text-center md:text-left">
            ...
            <p className="text-lg sm:text-2xl mb-8 font-medium">
              ShiftSync makes workforce management simple, fast, and
              collaborative for small businesses and their employees.
            </p>
            <a
              href="/signup"
              className="inline-block px-8 py-3 bg-white text-blue-700 font-bold rounded-lg shadow hover:bg-blue-50 transition text-lg transform hover:scale-105 focus:scale-105 active:scale-95 duration-200"
            >
              Get Started Free
            </a>
              ...
              {features.map((feature, idx) => (
                <div key={feature.title}>
                  ...
                  {activeFeature === idx && (
                    ...
                    >
                      <div className="text-blue-700 mb-2 text-base">
                        {feature.desc}
                      </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="relative w-full max-w-md">
              ...
              <Image
                ...
                alt={
                  features[activeFeature].imageAlt ||
            ...
            {[
              {
                icon: "🛠️",
                title: "Plan & Build",
                desc: "Schedule in a few clicks with templates or drag-and-drop tools.",
              },
              {
                icon: "📤",
                title: "Share & Confirm",
                desc: "Instantly publish schedules for your team to view and approve.",
              },
              {
                icon: "🔄",
                title: "Stay in Control",
                desc: "Handle last-minute changes, see workflow, and reach staff live.",
              },
              {
                icon: "💸",
                title: "Sync & Pay",
                desc: "Link to time clock, generate timesheets, and integrate with payroll.",
              },
            ].map((step, i) => (
              <div
                key={step.title}
              ...
              >
                <div className="bg-blue-100 rounded-full p-4 mb-3 text-2xl">
                  {step.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-blue-700 mb-6">
              See how ShiftSync helps you create, share, and manage schedules in
              just a few clicks. Watch our quick demo!
            </p>
            <a
              href="/signup"
              className="inline-block px-6 py-3 bg-blue-200 text-blue-800 font-bold rounded-lg shadow hover:bg-blue-300 transition text-lg transform hover:scale-105 focus:scale-105 active:scale-95 duration-200"
            >
      ...
      <section className="w-full py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h4 className="text-blue-700 font-semibold mb-4 text-center">
            Award-Winning Scheduling Software
          </h4>
          <div className="flex flex-wrap gap-6 justify-center items-center">
            {[
              ...
              <div
                key={badge}
                className="bg-blue-100 rounded-full px-6 py-2 text-blue-700 font-bold shadow text-sm"
              >
                {badge}
              </div>
            ))}
      ...
      <section id="pricing" className="w-full py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-blue-700 mb-6">
              ShiftSync is free for small teams. Get unlimited access to all
              premium features at no cost for up to 10 users!
            </p>
            <a
              href="/signup"
              className="inline-block px-6 py-3 bg-blue-200 text-blue-800 font-bold rounded-lg shadow hover:bg-blue-300 transition text-lg transform hover:scale-105 focus:scale-105 active:scale-95 duration-200"
          ...
          <div className="w-full max-w-2xl mx-auto">
            {faqs.map((faq, idx) => (
              <div key={faq.q} className="mb-4 border-b border-blue-100">
                ...
                {openFaq === idx && (
                  <div
                    className="px-2 pb-4 text-blue-600 animate-fadein"
                    style={{
                      animationDelay: "0.1s",
                      animationFillMode: "both",
                    }}
      ...
      <footer className="w-full bg-gradient-to-br from-blue-100 via-blue-50 to-white border-t border-blue-100 mt-auto py-10">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4 items-center">
            ...
            >
              <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path
                  d="M22.675 0h-21.35c-.733 0-1.325.592-1.325 1.325v21.351c0 .732.592 1.324 1.325 1.324h11.495v-9.294h-3.124v-3.622h3.124v-2.671c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24h-1.918c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12v9.294h6.116c.73 0 1.322-.592 1.322-1.324v-21.35c0-.733-.592-1.325-1.325-1.325z"
                  fill="currentColor"
                />
              </svg>
            </a>
        ...
        <div className="text-center text-blue-300 text-xs mt-6">
