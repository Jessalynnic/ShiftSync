  ...
  const fetchBusinessDetails = async (bId) => {
    try {
      ...
      try {
        ...
        console.log('Business table not found or no data, using default values');
      ...
      try {
        ...
        console.log('Business locations table not found or no data, using default values');
      }
      ...
      try {
        ...
        if (uploadError) {
          ...
          if (uploadError.message.includes('bucket') || uploadError.message.includes('not found')) {
            console.log('Storage bucket not found, skipping photo upload for now');
            setError('Photo upload temporarily unavailable. Please try again later.');
            return;
          }
        ...
        try {
          ...
          if (updateError) {
            console.log('Could not update business table with photo URL:', updateError);
        ...
        throw new Error(`Failed to upload photo: ${storageError.message || 'Unknown error'}`);
      }
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Business locations table not found. Please create the table first.');
      }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
        {/* Header */}
        <DashboardHeader title="Business Account" sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} loading={loading} handleLogout={handleLogout} />
        ...
        <div className="flex-1 p-6">
          <div className="max-w-6xl mx-auto">
            {/* Page Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900">Business Account</h1>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">{businessName || 'Business Name'}</h2>
