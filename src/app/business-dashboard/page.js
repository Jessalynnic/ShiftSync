...
function OverviewCard({ title, value, icon, loading = false }) {
  return (
    <div className="flex items-center gap-4 bg-white rounded-2xl shadow-lg border border-blue-50 p-6 min-w-[180px] transition-transform hover:-translate-y-1 hover:shadow-xl">
      ...
      <div>
        <div className="text-2xl font-bold text-blue-900">
          {loading ? (
            <div className="animate-pulse bg-blue-100 h-8 w-12 rounded"></div>
          ) : (
            value
          )}
        </div>
        <div className="text-blue-500 text-sm font-semibold mt-1">{title}</div>
      </div>
    </div>
  );
}
...
function RecentActivitiesSection({ businessId }) {
  ...
  return (
    <section className="mb-8 bg-white rounded-2xl shadow-lg border border-blue-50 p-6">
      ...
      {loading ? (
        <div className="text-blue-400 text-sm py-8 text-center">
          Loading activities...
        </div>
      ) : error ? (
        ...
        <div className="max-h-80 overflow-y-auto">
          <ul className="space-y-4">
            {activities.slice(0, 4).map((activity) => (
              <li
                key={activity.id}
                className="flex items-start gap-3 bg-blue-50 rounded-lg p-3 shadow-sm"
              >
          ...
          {activities.length > 4 && (
            <div className="text-center mt-4 pt-4 border-t border-blue-50">
...
export default function BusinessDashboard() {
  ...
  const [showProfileCompletionBanner, setShowProfileCompletionBanner] =
    useState(false);
    ...
    async function fetchEmployeeCount() {
      ...
      try {
        const response = await fetch(
          `/api/get-employee-count?businessId=${businessId}`,
        );
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
        ...
        <div className="flex-1 px-4 md:px-8 lg:px-16 py-8">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-purple-700 mb-4">
                    Welcome to ShiftSync! To get started, please update your
                    employee profile with your personal information.
                  </p>
                  ...
                  <div className="flex gap-3">
                    <button
                      onClick={() =>
                        router.push("/business-dashboard/manage-employees")
                      }
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-green-700 mb-4">
                    Great job! Your profile is now complete. You're all set to
                    start managing your team with ShiftSync.
                  </p>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 border-l-4 border-green-400 p-6 mx-6 mt-6 rounded-lg">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-green-700 mb-4">
                    Your business account is now fully set up! Here's what you
                    can do next:
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      ...
                      <p className="text-sm text-green-600 mb-3">
                        Start building your team by adding employees to your
                        business.
                      </p>
                      <button
                    ...
                    <div className="bg-white p-4 rounded-lg border border-green-200">
                      ...
                      <p className="text-sm text-green-600 mb-3">
                        Create different roles and permissions for your team
                        members.
                      </p>
                      <button
                        onClick={() =>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                      <li>
                        • You can log in with either your business email or
                        Employee ID
                      </li>
                      <li>
                        • Send new employees onboarding emails with their
                        employee ID and default passwords
                      </li>
                      <li>
                        • Employees can change their passwords after first login
                      </li>
                      <li>
                        • Use the dashboard to monitor employee activity and
                        manage your team
                      </li>
                    </ul>
                  </div>
          ...
          {/* Schedule Overview - Top and Full Width */}
          <div className="mb-8">
            <ScheduleOverview businessId={businessId} />
          </div>
                  ...
                  <li className="px-6 py-4 hover:bg-blue-50 transition">
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-blue-700 mt-1">
                        Masks are now optional for all employees.
                      </span>
                    </div>
                  </li>
                  <li className="px-6 py-4 hover:bg-blue-50 transition">
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-blue-700 mt-1">
                        All staff meeting at 3pm in the break room.
                      </span>
                    </div>
                  </li>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-0 overflow-hidden flex flex-col">
                ...
                <ul className="divide-y divide-blue-50">
                  ...
                  <li className="px-6 py-4 flex items-center gap-3 hover:bg-blue-50 transition">
                    <Image
                      src="/images/avatars/hailee_steinfeld.jpg"
                  ...
                  <li className="px-6 py-4 flex items-center gap-3 hover:bg-blue-50 transition">
                    <Image
                      src="/images/avatars/gordon_ramsay.jpg"
                      alt="Gordon Ramsay"
                      width={32}
                      height={32}
                      className="w-8 h-8 rounded-full object-cover"
