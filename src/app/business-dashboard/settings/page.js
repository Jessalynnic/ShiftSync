  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="lg:ml-64 flex flex-col min-h-screen">
        {/* Top Nav Bar */}
        <DashboardHeader title="Settings" sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} loading={loading} handleLogout={handleLogout} />
        ...
        <div className="flex-1 p-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Manage your business settings and configurations</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              >
                ...
                <span className="text-sm text-gray-500">Configure email templates and notifications</span>
                <svg
            ...
            <section>
              ...
              >
                ...
                <span className="text-sm text-gray-500">Update your business details and preferences</span>
                <svg
                ...
                {businessInfoOpen && (
                  <div className="bg-white border border-blue-100 rounded-xl shadow p-6 mt-2">
                    <div className="text-center text-gray-500 py-8">
                      <p>Business information settings will be available here</p>
                    </div>
                  </div>
                )}
              </div>
            ...
            <section>
              ...
              >
                ...
                <span className="text-sm text-gray-500">Manage security settings and data privacy</span>
                <svg
